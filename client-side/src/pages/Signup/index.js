...
const Signup = () => {
    ...
    <div>
        ...
        <div className="s"><h2>SignUp </h2></div>
        <div className="row">
        ...
        <div className="mb-3">
            ...
            type="text" placeholder="Enter City" className="form-control"/>
        </div>
        ...
        <div className="mb-3">
            ...
            type="text" placeholder="Enter State" className="form-control"/>
        </div>
        ...
        <div className="mb-3">
            ...
            type="text" placeholder="Enter Phone" className="form-control"/>
        </div>
